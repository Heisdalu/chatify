...
const ReceiverChat = ({ item }: { item: Messages }) => {
  return (
    <DragComponent className="p-[0.5rem] rounded-[10px] leading-[1.3rem] inline-block border-gray-200 border-[1px] w-auto max-w-[200px] [word-break:break-word] space-y-[5px] md:max-w-[300px]">
